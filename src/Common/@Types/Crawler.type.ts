...
//     tapsiFood: { name: string; price: number; available: boolean } | undefined;
//     snapFood: { name: string; price: number; available: boolean } | undefined;
//   }[];
//   snapFoodNotMatch: { name: string; price: number; available: boolean }[];
//   tapsiFoodNotMatch: { name: string; price: number; available: boolean }[];
// };
