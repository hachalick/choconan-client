...
import Datalist from "@/Components/Element/Details";
import Summery from "@/Components/Element/Summary";
    ...
    <Layout variant="website">
      <ShowNestedRoute
        list_route={[
          ...
          { path: EInnerRoute.FAQ, name: "سوالات متداول" },
        ]}
      />
      <Datalist>
        <Summery variant="primary">نحوه رزرو کردن کافه شونان</Summery>
        <Box variant="guest">
